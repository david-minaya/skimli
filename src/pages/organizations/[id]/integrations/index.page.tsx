...
function Integrations() {
  ...
  const availableNowIntegrationsContent =
    getIntegrationsPageContent?.availableNow;
      ...
      <Box sx={style.page}>
        ...
        <Container sx={style.content} maxWidth='lg'>
          <Grid container sx={style.layout}>
            <Grid item>
              <Typography sx={style.pageHeadline}>
                {t('pageSubtitle')}
              </Typography>
                  ...
                  {currentIntegrations.map((integration: UserIntegration) => (
                    <Grid item key={integration.code}>
                      <IntegrationCard
                        ...
                        cardContent={availableNowIntegrationsContent?.find(
                          (content) =>
                            content.integrationCode ===
                            IntegrationCodeType[integration.code]
                        )}
                        isCurrent={true}
                        isAvailable={false}
