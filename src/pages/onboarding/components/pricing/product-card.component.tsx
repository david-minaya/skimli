...
import {Button, Divider, Grid, MenuItem, Paper, Select, SelectChangeEvent, Typography} from "@mui/material";
...
export function ProductCard(props: Props) {
    ...
    const [plan, setPlan] = useState<Plan | null | undefined>(product?.plansCollection?.items?.[0]);

    function handleChange(e: SelectChangeEvent<string>) {
        const selectedPlanCode = e.target.value;
        const selectedPlan = product?.plansCollection?.items?.find(plan => plan.code === selectedPlanCode);
